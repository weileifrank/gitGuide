...
import com.lft.hileia.BuildConfig
...
class NetManager private constructor() {
    ...
    companion object {
        ...
        const val BASE_URL_RELEASE = "http://192.168.26.71/"
...
inline fun <reified T> parseJsonToList(json: String): MutableList<T> =
    gson.fromJson(json, ParameterizedTypeImpl(T::class.java))
